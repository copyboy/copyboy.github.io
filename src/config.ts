...
export const GiscusConfig: Record<string, string> = {
	'data-repo': 'copyboy/copyboy.github.io',
	'data-repo-id': 'R_kgDONWIBvw',
	'data-category': 'Announcements',
	'data-category-id': 'DIC_kwDONWIBv84CksRX',
